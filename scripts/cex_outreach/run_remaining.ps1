...
Write-Host ""
Write-Host "[7] Dev video — DONE"
Write-Host "    File: C:\Users\Admin2\IONOS HiDrive\Build Files\Kaspa Video\out\kaspa_dev_quickstart.mp4"
Write-Host "    Open: powershell -File scripts/cex_outreach/open_video.ps1"
Write-Host ""
