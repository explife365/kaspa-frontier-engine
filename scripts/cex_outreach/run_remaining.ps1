...
Write-Host "    Drafts: scripts/cex_outreach/open_gmail_drafts.ps1"
Write-Host ""
Write-Host "[6] Jackpot draw when round ends"
Write-Host "    powershell -File scripts/galleon_jackpot_draw_when_ready.ps1"
Write-Host ""
Write-Host "[7] Dev video (beast / local record)"
Write-Host "    Script: scripts/media/dev_video_script.txt"
Write-Host "    Record: examples/kaspa_frontier_dashboard.html + terminal"
Write-Host ""
